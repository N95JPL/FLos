...
const { VINDecode } = require('../../../../../main/resources/JSON/VINDecode')
const { Vehicle_Manifest } = require('../../../../../main/resources/JSON/Vehicle_Manifest')
            ...
            for (
              ...
              if (
                ...
                if (
                  ...
                  var option =
                    data.configuration_data.block[blockID].group[x].parameter.select.option[y].tm.id
