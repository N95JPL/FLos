...
const { mediumSpeed, mediumSpeedPrev } = require('./resources/VariableMaps/MediumSpeedVar')
...
module.exports = function (window, dev) {
  ...
  // create can can0
  const can0 = can.createRawChannel('can0', true)
  console.log('CAN0 Started')
  const can1 = can.createRawChannel('can1', true)
